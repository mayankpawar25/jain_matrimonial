...
@section('content')
    ...
    <script type="text/javascript" src="https://www.gstatic.com/inputtools/js/ln/j/transliteration.js"></script>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="d-flex justify-content-start form-control">
                                        <div class="form-check mr-3">
                                            ...
                                            <label class="form-check-label " for="gender_male">युवक</label>
                                        </div>
                                        <div class="form-check ">
                                            <input class="form-check-input" type="radio" name="gender" id="gender_female"
                                                value="female">
                                            <label class="form-check-label" for="gender_female">युवती</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-step" id="step-2">
                            ...
                            <div class="row ">
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="married_brother" name="married_brother">
                                </div>
                                <div class="col-md-3 mb-3">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="married_sister" name="married_sister">
                                </div>
                                <div class="col-md-3 mb-3">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12 mb-3">
                                    <label for="social-group" class="form-label">सोशल ग्रुप से सम्बन्धता हे? तो ग्रूप का
                                        नाम</label>
                                    <input type="text" class="form-control" id="social_group" name="social_group"
                                        placeholder="">
                                </div>
                            </div>
                            ...
                            <div class="container my-5">
                                ...
                                <div class="row ml-0">
                                    <div class=" column-md-4 custom-upload-box mr-3" style="position: relative;">
                                        <input type="file" accept="image/*" class="form-control" id="image-input-1"
                                        ...
                                        <img id="preview-image-1" src="#" alt="Image Preview"
                                            style="display: none; max-width: 100%; height: auto; margin-top: 10px;">
                                        <button type="button" id="remove-image-1" class="remove-image" style="display:none;"
                                            title="Remove Image">
                                    ...
                                    <div class="column-md-4 custom-upload-box mr-3"
                                        style="position: relative; display: none;" id="extra-image-box-2">
                                        <input type="file" accept="image/*" class="form-control" id="image-input-2"
                                        ...
                                        <img id="preview-image-2" src="#" alt="Image Preview"
                                            style="display: none; max-width: 100%; height: auto; margin-top: 10px;">
                                        <button type="button" id="remove-image-2" class="remove-image" style="display:none;"
                                            title="Remove Image">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="red"
                                                class="bi bi-x-circle" viewBox="0 0 16 16">
                                                <path
                                    ...
                                    <div class="column-md-4 custom-upload-box" style="position: relative; display: none;"
                                        id="extra-image-box-3">
                                        <input type="file" accept="image/*" class="form-control" id="image-input-3"
                                            name="profile_picture[]">
                                        <svg height="50" width="50" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                            stroke-linejoin="round">
                                        ...
                                        <img id="preview-image-3" src="#" alt="Image Preview"
                                            style="display: none; max-width: 100%; height: auto; margin-top: 10px;">
                                        <button type="button" id="remove-image-3" class="remove-image" style="display:none;"
                                            title="Remove Image">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="red"
                                                class="bi bi-x-circle" viewBox="0 0 16 16">
                                                <path
    ...
    <script>
        ...
        function setupHindiTranslation(id, delay = 1200) {
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            setupHindiTranslation("state", 1200); // 1.2 second delay
            setupHindiTranslation("gotraSelf", 1200); // 1.2 second delay
            setupHindiTranslation("gotraMama", 1200); // 1.2 second delay
            setupHindiTranslation("caste", 1200); // 1.2 second delay
            setupHindiTranslation("subCaste", 1200); // 1.2 second delay
            setupHindiTranslation("residence", 1200); // 1.2 second delay
            setupHindiTranslation("education", 1200); // 1.2 second delay
            setupHindiTranslation("occupation", 1200); // 1.2 second delay
            setupHindiTranslation("name_of_org", 1200); // 1.2 second delay
            setupHindiTranslation("annual_income", 1200); // 1.2 second delay
            setupHindiTranslation("father_name", 1200); // 1.2 second delay
            setupHindiTranslation("father_occupation", 1200); // 1.2 second delay
            setupHindiTranslation("father_income", 1200); // 1.2 second delay
            setupHindiTranslation("mother_name", 1200); // 1.2 second delay
            setupHindiTranslation("mother_occupation", 1200); // 1.2 second delay
            setupHindiTranslation("mother_income", 1200); // 1.2 second delay
            setupHindiTranslation("permanent_address", 1200); // 1.2 second delay
            setupHindiTranslation("sibling", 1200); // 1.2 second delay
            setupHindiTranslation("married_brother", 1200); // 1.2 second delay
            setupHindiTranslation("unmarried_brother", 1200); // 1.2 second delay
            setupHindiTranslation("married_sister", 1200); // 1.2 second delay
            setupHindiTranslation("unmarried_sister", 1200); // 1.2 second delay
