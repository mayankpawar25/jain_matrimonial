        ...
        <div class="col-lg-9">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <td>{{ ($member->member && !empty($member->member->birthday)) ? date('Y-m-d', strtotime($member->member->birthday)) : ''}}</td>
                        </tr>
                        <tr>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table">
                          ...
                          <td>
                              @if($member->member && !empty($member->member->mothere_tongue) && $member->member->mothereTongue != null)
                          ...
                          <td>
                            @if($member->member && !empty($member->member->known_languages))
