...
class MemberOtherDetailsController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $this->messages = [
            ...
            'annual_income.max'                                      => translate('Max 255 characters'),
            ...
            'father_annual_income.max'                               => translate('Max 255 characters'),
            ...
            'mother_annual_income.max'                               => translate('Max 255 characters'),
